...
<body class="p-4 flex flex-col items-center justify-center min-h-screen">
    ...
    <div class="w-full max-w-md bg-black/70 backdrop-blur-xl border border-purple-500/30 rounded-3xl p-6 shadow-[0_0_40px_rgba(138,43,226,0.3)]">
        ...
        <div class="text-center space-y-2 mb-6">
            ...
            <p class="text-xs text-purple-300 font-bold bg-purple-500/10 border border-purple-500/30 py-1.5 px-3 rounded-full inline-block">
                أدخل رقم الحساب وكلمة المرور لتشغيل السكربت
            </p>
        </div>

        <!-- Manual Login Form in PHP App -->
        <div class="bg-purple-950/40 border border-purple-500/30 rounded-2xl p-4 mb-6 space-y-3 text-xs">
            <div>
                <label class="block text-purple-200 font-bold mb-1">رقم الحساب (10 أرقام):</label>
                <input type="text" id="phpAccountId" placeholder="مثال: 5666009187" maxlength="10" 
                       class="w-full bg-black/60 border border-purple-500/40 rounded-xl px-3 py-2 text-white font-mono text-sm outline-none focus:border-emerald-400" />
            </div>
            <div>
                <label class="block text-purple-200 font-bold mb-1">كلمة المرور (البروموكود):</label>
                <input type="password" id="phpPassword" placeholder="أدخل كلمة المرور (مثال: JMK2)" 
                       class="w-full bg-black/60 border border-purple-500/40 rounded-xl px-3 py-2 text-white font-mono text-sm outline-none focus:border-emerald-400" />
            </div>
            <div class="flex justify-between items-center text-[11px] pt-1 text-purple-300/80 border-t border-purple-500/20">
                <span>الحد الأدنى للإيداع: <b class="text-yellow-300">150 ج.م أو $3</b></span>
